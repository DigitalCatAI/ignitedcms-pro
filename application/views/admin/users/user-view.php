                  ...
                  <table class="table table-striped b-t" id="example">
                    ...
                    <tbody>
                    	<?php foreach ($query->result() as $row): ?>
                            ...
                            <td>
                              <div class="pull-right" data-toggle="popover" data-html="true" data-placement="top" data-content='<?php echo anchor("admin/users/search_users_or_delete/$id", 'Delete', 'attributs'); ?>' title="" data-original-title='<button type="button" class="close pull-right" data-dismiss="popover">&times;</button>Delete'> <i class="fa fa-trash-o"></i> <strong></strong> 
                                  </div>
