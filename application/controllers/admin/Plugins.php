    ...
    public function unzip_and_import($filename)
    {
     ...
     public function create_files($filename)
     {
        ...
        ***************************/
         ...
         $string = read_file("$input/index-mobile.php");
        
        

        if ( ! write_file("$output/$filename/index-mobile.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        {
          ...
          $string = read_file("$input/new-mobile.php");
        


        if ( ! write_file("$output/$filename/new-mobile.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        //////////////////////////////////////////////////////////edit file
        $string = read_file("$input/edit-mobile.php");
        


        if ( ! write_file("$output/$filename/edit-mobile.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        ////////////////////////////////////////////////////////////////////////breadcrumb all
        $string = read_file("$input/breadcrumb-all-mobile.php");
        
        

        if ( ! write_file("$output/$filename/breadcrumb-all-mobile.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        ////////////////////////////////////////////////////////////////////////breadcrumb edit
        $string = read_file("$input/breadcrumb-edit-mobile.php");
        
       

        if ( ! write_file("$output/$filename/breadcrumb-edit-mobile.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        ////////////////////////////////////////////////////////////////////////breadcrumb new
        $string = read_file("$input/breadcrumb-new-mobile.php");
        
       

        if ( ! write_file("$output/$filename/breadcrumb-new-mobile.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
