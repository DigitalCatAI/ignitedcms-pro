 ...
 <script type="text/javascript">
    ...
    $('#example').dataTable( {
      ...
      $('#add-block2').click(function (event) {
              counter++;
              data = '<div class="form-group"><input name="opts-namec'+counter+'" type="text"  data-maxlength="200" class="form-control" placeholder="Type option here" data-toggle="tooltip" data-placement="top" title="" value=""></div>';
