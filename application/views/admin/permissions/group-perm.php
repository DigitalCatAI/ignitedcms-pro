                    ...
                    <tbody>
                    	<?php foreach ($query->result() as $row): ?>
                    		...
                    		<tr>
		                        ...
		                        <td>...</td>
		                        <td>
		                        	<div class="pull-right" data-toggle="popover" data-html="true" data-placement="top" data-content='<?php echo anchor("admin/permissions/search_permissions_or_delete/$id", 'Delete', 'attributs'); ?>' title="" data-original-title='<button type="button" class="close pull-right" data-dismiss="popover">&times;</button>Delete'> <i class="fa fa-trash-o"></i> <strong></strong> 
	       	                </div>
		                        </td>
                      		</tr>
                    	<?php endforeach ?>
