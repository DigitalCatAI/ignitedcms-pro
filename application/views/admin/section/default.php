                    ...
                    <tbody>
                    	<?php foreach ($query->result() as $row): ?>
                    		...
                    		<tr>
		                        ...
		                        <td> 
                              <div class="pull-right" data-toggle="popover" data-html="true" data-placement="top" data-content='<?php echo anchor("admin/sections/search_posts_or_delete/$id", 'Delete', 'attributs'); ?>' title="" data-original-title='<button type="button" class="close pull-right" data-dismiss="popover">&times;</button>Delete'> <i class="fa fa-trash-o"></i> <strong></strong> 
                                  </div>
