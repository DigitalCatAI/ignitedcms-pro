          ...
          <div class="pull-right btn btn-sm  btn-info btn-rounded" data-toggle="popover" data-html="true" data-placement="bottom" data-content="Save your multipes" title="" data-original-title='<button type="button" class="close pull-right" data-dismiss="popover">&times;</button>Info'> <i class="fa fa-question"></i> <strong></strong> 
	       ...
	       <section class="panel">
	           ...
	           <div class="panel-body">
	           	...
	           	<!-- search and sort -->
              <?php  echo form_open_multipart("admin/entries/search_posts_or_delete/$sect_id",$atts); ?>
	           	<div class="row" >
	           		<div class="col-sm-2">
                    ...
                    <ul id='shit'>
                    	...
                    	<?php $sectionid = $row->sectionid;
                    		...
                    		?>
                    		<li class='blobs' mid="<?php echo $id; ?>">
                            ...
                            <div class="fa fa-bars pull-right" 
                          </div>
                      		</li>
                    	<?php endforeach ?>
                    ...
                    <div  class="btn btn-purplet btn-s-xs pull-right" id='save'> <strong>Save Order</strong></div>
