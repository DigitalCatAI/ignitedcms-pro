                        ...
                        <div class="panel">
                          <div class="panel-heading">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
                              <strong>Links</strong> (Now implemented!)
                            </a>
                          </div>
                          <div id="collapseThree" class="panel-collapse collapse" style="height: 0px;">
                             <?php $atts= array( 'data-validate'=>'parsley'); echo form_open_multipart('admin/menu/add_custom_url_to_menu',$atts); ?>
                            <div class="panel-body text-sm">
                                <div class="form-group">
                                    <label>Url</label>
                                    <input name="url" type="text" data-required="true" data-maxlength="100" class="form-control" placeholder="E.g custom/controller/method" data-toggle="tooltip" data-placement="top" title="url" value="">
                                </div>
                                <div class="form-group">
