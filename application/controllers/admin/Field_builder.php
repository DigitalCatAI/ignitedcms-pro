...
class Field_builder extends CI_Controller {
    ...
    /*=======================================================
       Matrix field testing
     ========================================================*/

     public function add_new_matrix()
     {
     	$data['type'] = 'plain-text';

     	$this->load->view('admin/header');
		$this->load->view('admin/body');
		$this->load->view('admin/fields/matrix-detail',$data); 
		$this->load->view('admin/fields/footer-matrix',$data);
     ...
     public function tryME()
     {
     	$this->load->view('admin/header');
		$this->load->view('admin/body');
		$this->load->view('admin/fields/try'); 
		$this->load->view('admin/fields/footer-matrix2');
      ...
      /**
       *  @Description: quick test to save matrix entries
       *       @Params: params
       *
       *  	 @returns: returns
       */
     ...
     public function save_matrix()
     {
     	...
     	$matrix_name = $this->input->post('matrix_name');
