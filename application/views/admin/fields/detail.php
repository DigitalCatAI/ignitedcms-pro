                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="igs-small">What this field will be called in the control panel. 
                          (This <strong>MUST</strong> be unique and must not contain numbers or spaces.) <br/>You can NOT use the following names: [url,content,id,section,field]</div>
                    ...
                    <div class="pm-drop-down" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <input name="opts-namec" type="text"  
                            data-maxlength="200" class="form-control" 
                            placeholder="Type option here" 
                            data-toggle="tooltip" 
                            data-placement="top" title="" value=""> </div>
